export default {
    ...
    riskControl: {
      ...
      confidenceThresholdHint: "A confidence score at or above this value is flagged. A standalone flagged boolean is used directly. When both are present, confidence takes precedence.",
      auditPrompt: "System prompt",
      auditPromptPlaceholder: "Paste your moderation system prompt here.",
      auditPromptHint: "Available as config.auditPrompt in the payload. Required for Chat Completions; the native Moderations endpoint does not accept system prompts.",
      payloadScript: "Request payload code (JavaScript)",
      payloadScriptPlaceholder: "Paste your const wrappedUserContent = ... and const requestBody = ... code. Leave empty for the default request.",
      ...
      insertPayloadExample: "Insert payload example",
      customCodeTestHint: "The model must return JSON with confidence (0–1) or flagged (boolean), optionally reason. Set the provider URL, model and Key in Basic settings, then run the audit test. Tests use your unsaved edits. API errors retain the existing fail-open behavior.",
